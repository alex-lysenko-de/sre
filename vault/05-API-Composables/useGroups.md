...
> **Историческая заметка (тикет 139).** Файл `src/composables/useGroups.js`
> **удалён тикетом 137** вместе с его основным потребителем
> (`ChildrenView.vue`). Ниже — описание для истории; за текущей реализацией
> подсчёта по группам см. [[Checkpoint]] (тип GROUP) и `useCheckpoints.js`.
