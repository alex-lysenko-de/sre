<!-- src/components/checkpoints/CheckpointTypeBadge.vue -->
<!-- Icon + Beschriftung fuer den Checkpoint-Typ (Bus/Group/Lazy). Ported
     from the 130_2 prototype (src/components/checkpoints-prototype/), only
     the composable import changed (real useCheckpoints.js instead of the
     mock) - see tickets/131/IMPLEMENTATION_PLAN.md. -->
<template>
