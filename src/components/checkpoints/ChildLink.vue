...
<!-- Ein Kind wird ueberall (Bus-Liste, Gruppen-Liste, Checkpoint-Breakdown,
     Lazy-Liste, Scan-Historie) identisch dargestellt und fuehrt immer zur
     selben Kind-Karte. Ported unchanged from the 130_2 prototype - purely
