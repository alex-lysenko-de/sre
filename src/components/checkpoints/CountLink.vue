<!-- src/components/checkpoints/CountLink.vue -->
<!-- Ticket 133 - Uebernahme aus checkpoints-prototype/CountLink.vue,
     unveraendert (keine Routenabhaengigkeit - der Klick wird von der
     aufrufenden View durchgereicht). -->
<template>
