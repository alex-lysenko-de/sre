...
<!-- Ticket 133 - Uebernahme aus checkpoints-prototype/EntityListCard.vue,
     unveraendert bis auf die Importpfade der Link-Komponenten (aus
     src/components/checkpoints/ statt .../checkpoints-prototype/). -->
<template>
