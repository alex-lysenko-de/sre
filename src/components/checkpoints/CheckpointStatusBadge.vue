...
<!-- Statuspunkt+Text (OPEN/FINISHED) + "ueberfaellig"-Hinweis + optionale
     Anomalie-Markierung. Ported from the 130_2 prototype - real
     useCheckpoints.js instead of the mock (see tickets/131/
     IMPLEMENTATION_PLAN.md). No CANCELLED status, matching the real schema
     (doc/db/checkpoints.sql). -->
<template>
