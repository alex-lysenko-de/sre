...
<!-- Statuspunkt+Text (OPEN/FINISHED), inkl. "ueberfaellig"-Hinweis
     ...
     CANCELLED entfaellt seit UX-Feedback Runde 1 (siehe
     useCheckpointsMock.js) - ersetzt durch removeCheckpoint(), das eine
     Checkpoint komplett aus der Liste entfernt statt sie mit einem Status
     zu markieren. -->
<template>
