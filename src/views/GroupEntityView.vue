<!-- src/views/GroupEntityView.vue -->
<!-- Ticket 133 - reales Pendant zu GroupEntityPrototypeView.vue.
     useCheckpoints.fetchGroupEntity() (siehe deren Kommentar - reales
     Pendant zu useGroupEntityMock.js, nicht einzeln in 133.txt benannt, aber
     fuer diesen Bildschirm noetig). Verlinkt zur Checkpoint-gebundenen
     Gruppenansicht (Ticket 134, /admin/checkpoints/group/:id). -->
<template>
...
import { fetchGroupEntity } from '@/composables/useCheckpoints'
