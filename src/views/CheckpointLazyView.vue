...
<!-- Ticket 131 - reale Detail-/Monitoring-Ansicht fuer eine Lazy-Checkpoint.
     Ported from the 130_2 prototype (CheckpointLazyPrototypeView.vue) -
     Datenquelle wechselt auf useCheckpoints.js/useLazyCheckpointProgress.js
     (echte Supabase-Abfragen), DebugTag entfernt. -->
<template>
