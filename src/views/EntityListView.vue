<!-- src/views/EntityListView.vue -->
<!-- Ticket 133 - reales Pendant zu EntityListPrototypeView.vue. Universelle
     Liste (Kind/Betreuer, egal ob ueber Bus/Gruppe/Checkpoint-Aggregat/
     Anwesend-/Fehlend-Liste geoeffnet), gesteuert per Query-Parameter, wie
     im Prototyp. getBusChildrenBreakdown/getGroupChildrenBreakdown/
     getDayBaselineCheckpoint sind hier async (useCheckpoints.js -
     tickets/133/133.txt, Kopfkommentar "Abweichung von der Mock-Signatur"). -->
<template>
