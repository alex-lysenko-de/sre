...
// Punkt 7-8): Paketaufbau + Business-Regel "falsche Gruppe"/Duplikat - dieselbe
// Logik wie ScannerGroupView.vue (Gruppen-Appell, Ticket 120) -, plus der
// 5-Sekunden-Inaktivitaets-Timer nach dem letzten erfolgreichen Scan, der das
// Panel automatisch schliesst und das Paket im Hintergrund sendet.
//
 ...
 */
export function useGroupScanSession(groupIdRef, childrenRef) {
