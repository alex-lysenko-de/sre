...
\restrict vUaUdcdZTcVvlXNdvldgEvuCfmNdC5KbUJ4ZMi3oKRFm244cmbDYIzWNXkl6UfC
...
--
-- Name: is_session_valid(text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.is_session_valid(session_token_hash text) RETURNS boolean
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
  RETURN EXISTS (
...
--
-- Name: on_children_today_change(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.on_children_today_change() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE
  cnt_today INT;
...
CREATE FUNCTION public.on_children_today_delete() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE
  cnt_today INT;
...
--
-- Name: on_scan_insert(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.on_scan_insert() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE
  v_group_id BIGINT;
...
CREATE FUNCTION public.recalculate_groups_today() RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
...
CREATE FUNCTION public.update_last_seen(user_uuid uuid) RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
  UPDATE public.users
...
--
-- Name: TABLE calendar; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.calendar IS 'day-user-group';
...
CREATE TABLE public.children (
    ...
    age smallint,
    schwimmer smallint DEFAULT '0'::smallint,
...
--
-- Name: children_today; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.children_today (
    ...
    group_id smallint,
    presence_today smallint DEFAULT '1'::smallint,
    presence_now smallint DEFAULT '0'::smallint,
    bus_today smallint,
    bus_now smallint,
    user_id bigint,
...
--
-- Name: children_today_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.children_today ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.children_today_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.config (
    ...
    access_level smallint DEFAULT '1'::smallint,
    name character varying,
    sort_order smallint
);
...
CREATE TABLE public.days (
    ...
    name character varying,
    abfahrt time without time zone,
    ankommen time without time zone,
    description text
);
...
--
-- Name: groups_today; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: groups_today_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.groups_today ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.groups_today_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.invites (
    ...
    created_at timestamp with time zone DEFAULT now(),
    used_by_email text,
    CONSTRAINT invites_role_check CHECK (((role = 'admin'::text) OR (role = 'user'::text)))
);


--
-- Name: reset_events; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.reset_events (
    ...
    event_type smallint DEFAULT '1'::smallint
);


--
-- Name: reset_events_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.reset_events ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.reset_events_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: user_group_day; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.user_group_day (
    ...
    user_id bigint,
    group_id smallint,
    "isPresentToday" smallint DEFAULT '0'::smallint,
    description character varying,
    bus_id smallint,
    "bMustWorkToday" smallint DEFAULT '0'::smallint,
    updated_at timestamp without time zone
);


--
-- Name: TABLE user_group_day; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.user_group_day IS 'User Ablauf';


--
-- Name: user_group_day_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.user_group_day ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.user_group_day_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE ONLY public.children
    ADD CONSTRAINT children_band_id_key UNIQUE (band_id);
...
--
-- Name: children_today children_today_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.children_today
    ADD CONSTRAINT children_today_pkey PRIMARY KEY (id);
...
--
-- Name: groups_today groups_today_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.groups_today
    ADD CONSTRAINT groups_today_pkey PRIMARY KEY (id);
...
--
-- Name: reset_events reset_events_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: scan_type scan_type_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scan_type
    ADD CONSTRAINT scan_type_id_key UNIQUE (id);


--
-- Name: scan_type scan_type_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scan_type
    ADD CONSTRAINT scan_type_pkey PRIMARY KEY (id);
...
--
-- Name: user_group_day user_group_day_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_group_day
    ADD CONSTRAINT user_group_day_pkey PRIMARY KEY (id);
...
--
-- Name: idx_challenges_challenge; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_challenges_challenge ON public.webauthn_challenges USING btree (challenge);
...
CREATE INDEX idx_children_band_id ON public.children USING btree (band_id);


--
-- Name: idx_children_today_group_presence; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_children_today_group_presence ON public.children_today USING btree (group_id, presence_today, presence_now);


--
-- Name: idx_reset_events_day_type; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_reset_events_day_type ON public.reset_events USING btree (day, event_type);
...
CREATE INDEX idx_scans_band_date ON public.scans USING btree (band_id, date);


--
-- Name: idx_scans_child_date; Type: INDEX; Schema: public; Owner: -
--
...
CREATE INDEX idx_sessions_revoked ON public.sessions USING btree (revoked) WHERE (revoked = false);
...
--
-- Name: children_today trg_on_children_today_delete; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_on_children_today_delete AFTER DELETE ON public.children_today FOR EACH ROW EXECUTE FUNCTION public.on_children_today_delete();
...
ALTER TABLE ONLY public.children_today
    ADD CONSTRAINT children_today_child_id_fkey FOREIGN KEY (child_id) REFERENCES public.children(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: reset_events reset_events_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.reset_events
    ADD CONSTRAINT reset_events_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id);
...
--
-- Name: scans scans_type_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scans
    ADD CONSTRAINT scans_type_fkey FOREIGN KEY (type) REFERENCES public.scan_type(id) ON UPDATE CASCADE ON DELETE SET NULL;


--
-- Name: user_group_day user_group_day_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_group_day
    ADD CONSTRAINT user_group_day_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
--
-- Name: user_group_day Admins have full access; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Admins have full access" ON public.user_group_day USING ((EXISTS ( SELECT 1
   FROM public.users
...
--
-- Name: config Allow admins to manage config; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Allow admins to manage config" ON public.config TO authenticated USING ((EXISTS ( SELECT 1
   FROM public.users
  WHERE ((users.user_id = auth.uid()) AND (users.role = 'admin'::text) AND (users.active = true))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM public.users
  WHERE ((users.user_id = auth.uid()) AND (users.role = 'admin'::text) AND (users.active = true)))));


--
-- Name: days Allow admins to manage days; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Allow admins to manage days" ON public.days TO authenticated USING ((EXISTS ( SELECT 1
   FROM public.users
  WHERE ((users.user_id = auth.uid()) AND (users.role = 'admin'::text) AND (users.active = true))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM public.users
  WHERE ((users.user_id = auth.uid()) AND (users.role = 'admin'::text) AND (users.active = true)))));
...
--
-- Name: children Allow authenticated users to create children; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Allow authenticated users to create children" ON public.children FOR INSERT TO authenticated WITH CHECK (true);
...
--
-- Name: reset_events Allow authenticated users to insert reset_events; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Allow authenticated users to insert reset_events" ON public.reset_events FOR INSERT TO authenticated WITH CHECK (true);


--
-- Name: children Allow authenticated users to modify children; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Allow authenticated users to modify children" ON public.children TO authenticated USING (true) WITH CHECK (true);


--
-- Name: children_today Allow authenticated users to read children_today; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Allow authenticated users to read children_today" ON public.children_today FOR SELECT TO authenticated USING (true);


--
-- Name: days Allow authenticated users to read days; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Allow authenticated users to read days" ON public.days FOR SELECT TO authenticated USING (true);


--
-- Name: groups_today Allow authenticated users to read reset_events; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Allow authenticated users to read reset_events" ON public.groups_today FOR SELECT TO authenticated USING (true);


--
-- Name: reset_events Allow authenticated users to read reset_events; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: reset_events Allow authenticated users to update reset_events; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Allow authenticated users to update reset_events" ON public.reset_events FOR UPDATE TO authenticated USING (true) WITH CHECK (true);


--
-- Name: children Allow authenticated users to view all children; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Allow authenticated users to view all children" ON public.children FOR SELECT TO authenticated USING (true);


--
-- Name: config Allow insert for all users; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Allow insert for all users" ON public.config FOR INSERT WITH CHECK (true);


--
-- Name: scans Allow insert for authenticated users; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Allow insert for authenticated users" ON public.scans FOR INSERT TO authenticated WITH CHECK (true);
...
--
-- Name: config Allow read for all users; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Allow read for all users" ON public.config FOR SELECT USING (true);


--
-- Name: scans Allow read for authenticated users; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Allow read for authenticated users" ON public.scans FOR SELECT TO authenticated USING (true);


--
-- Name: config Allow update for all users; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Allow update for all users" ON public.config FOR UPDATE USING (true);


--
-- Name: days Enable insert for authenticated users; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Enable insert for authenticated users" ON public.days FOR INSERT TO authenticated WITH CHECK (true);


--
-- Name: days Enable select for authenticated users; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Enable select for authenticated users" ON public.days FOR SELECT TO authenticated USING (true);


--
-- Name: days Enable update for authenticated users; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Enable update for authenticated users" ON public.days FOR UPDATE TO authenticated USING (true);


--
-- Name: config Public read access; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Public read access" ON public.config FOR SELECT USING ((access_level = 3));


--
-- Name: user_group_day Users can create their own schedule; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can create their own schedule" ON public.user_group_day FOR INSERT WITH CHECK ((user_id = ( SELECT users.id
   FROM public.users
  WHERE (users.user_id = auth.uid()))));


--
-- Name: user_group_day Users can update their own schedule; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can update their own schedule" ON public.user_group_day FOR UPDATE USING ((user_id = ( SELECT users.id
   FROM public.users
  WHERE (users.user_id = auth.uid()))));


--
-- Name: user_group_day Users can view their own schedule; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can view their own schedule" ON public.user_group_day FOR SELECT USING ((user_id = ( SELECT users.id
   FROM public.users
  WHERE (users.user_id = auth.uid()))));


--
-- Name: sessions Users can view their own sessions; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: children_today; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.children_today ENABLE ROW LEVEL SECURITY;
...
--
-- Name: groups_today; Type: ROW SECURITY; Schema: public; Owner: -
--
...
ALTER TABLE public.scan_type ENABLE ROW LEVEL SECURITY;
...
--
-- Name: user_group_day; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.user_group_day ENABLE ROW LEVEL SECURITY;
...
--
-- Name: users users_delete_admins_only; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY users_delete_admins_only ON public.users FOR DELETE TO authenticated USING (public.has_role('admin'::text));


--
-- Name: users users_insert_admins_only; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY users_insert_admins_only ON public.users FOR INSERT TO authenticated WITH CHECK (public.has_role('admin'::text));


--
-- Name: users users_select_admins_all; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY users_select_admins_all ON public.users FOR SELECT TO authenticated USING (public.has_role('admin'::text));
...
--
-- Name: users users_update_admins_all; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY users_update_admins_all ON public.users FOR UPDATE TO authenticated USING (public.has_role('admin'::text)) WITH CHECK (true);
...
--
-- Name: supabase_realtime children; Type: PUBLICATION TABLE; Schema: public; Owner: -
--
...
--
-- Name: supabase_realtime children_today; Type: PUBLICATION TABLE; Schema: public; Owner: -
--
...
--
-- Name: supabase_realtime groups_today; Type: PUBLICATION TABLE; Schema: public; Owner: -
--
...
--
-- Name: supabase_realtime reset_events; Type: PUBLICATION TABLE; Schema: public; Owner: -
--
...
--
-- Name: supabase_realtime user_group_day; Type: PUBLICATION TABLE; Schema: public; Owner: -
--
...
\unrestrict vUaUdcdZTcVvlXNdvldgEvuCfmNdC5KbUJ4ZMi3oKRFm244cmbDYIzWNXkl6UfC
